...
@pytest.fixture
def temporary_app_settings(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> str:
    ...
    monkeypatch.setattr(
        ...
        lambda _workspace_path: "테스트용 런타임 지침",
    )
...
def test_lifespan_initializes_database(temporary_app_settings: str) -> None:
